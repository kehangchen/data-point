...
public class StreamLambdaHandlerTest {
    ...
    public void ping_streamRequest_respondsWithHello() {
        InputStream requestStream = new AwsProxyRequestBuilder("/dps", HttpMethod.GET)
        ...
        assertTrue(response.getBody().contains("propertyAddress"));
        assertTrue(response.getBody().contains("propertyType"));
    ...
    public void invalidResource_streamRequest_responds404() {
        InputStream requestStream = new AwsProxyRequestBuilder("/nodps", HttpMethod.GET)
                                            .header(HttpHeaders.ACCEPT, MediaType.APPLICATION_JSON)
                                            .buildStream();
        ByteArrayOutputStream responseStream = new ByteArrayOutputStream();
